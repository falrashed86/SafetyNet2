...
MODEL_PATH = BASE_DIR / "model" / "nb_model.pkl"
VECTORIZER_PATH = BASE_DIR / "model" / "nb_vectorizer.pkl"
...
print("\nNaive Bayes model saved to:", MODEL_PATH)
print("Naive Bayes vectorizer saved to:", VECTORIZER_PATH)
